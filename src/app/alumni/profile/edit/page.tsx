      ...
      <div className="mx-auto max-w-3xl px-6 pt-28 pb-12">
        ...
        <div className="relative mt-6 overflow-hidden rounded-[18px] border border-white/8 bg-[#151517] p-6 sm:p-8">
          ...
          <div className="relative">
            ...
            <h1 className="mt-2 font-heading text-3xl font-bold tracking-[-0.03em] text-white sm:text-4xl">Edit profile</h1>
            <p className="mt-1.5 text-sm text-white/45">Update your personal information, bio, and links.</p>
          </div>
        </div>
